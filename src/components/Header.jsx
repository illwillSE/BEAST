import { Undo2, Redo2, Save, Download, Settings, ChevronDown } from 'lucide-react'

// Top chrome: brand, current sprite name, undo/redo, save/export. Mockup — no
// handlers wired; buttons are placeholders.
  ...
  return (
    <header className="flex items-center gap-3 px-3 h-12 bg-panel border-b border-divider shrink-0">
      ...
      <button className="flex items-center gap-1.5 px-2 py-1 rounded text-sm text-ink-soft hover:bg-surface-hover">
        <span className="font-medium">hero_walk</span>
      ...
      <button className="flex items-center gap-1.5 px-2.5 py-1.5 rounded text-sm bg-surface hover:bg-surface-hover text-ink-soft">
        <Save size={15} /> Save
      </button>
